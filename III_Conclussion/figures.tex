...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.325\textwidth}
        ...
        \caption{Tested on US06}
        \label{subfig:Model-3res-FUDSvsUS}
    \end{subfigure}
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.325\textwidth}
        ...
        \caption{Validated on DST}
        \label{subfig:Model-4res-DSTvsDST}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.325\textwidth}
        \centering
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.325\textwidth}
        ...
        \caption{Tested on US06}
    \end{subfigure}
    \caption{Model 5: Single Layer Stateless GRU.\textbf{TODO: DO NOT FORGET TO Verefy the US06 before send it for review. THe plots used to have better accuracy}}
