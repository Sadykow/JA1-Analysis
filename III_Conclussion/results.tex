...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includesvg[width=\linewidth]{III_Conclussion/Results/3/loss1.svg}
        \caption{Loss1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includesvg[width=\linewidth]{III_Conclussion/Results/3/loss2.svg}
        \caption{Loss2}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includesvg[width=\linewidth]{III_Conclussion/Results/3/loss3.svg}
        \caption{Loss3}
    \end{subfigure}
