...
Due to MLs' stochastic nature, the training results had a huge variance, similar to Subfigure~\ref{subfig:Model-DEMO-10} and ~\ref{subfig:Model-DEMO2-10}.
...
Figures~\ref{fig:Model-DEMO} and~\ref{fig:Model-DEMO2} represents the difference between single and multiple averaged models and the general spread.
