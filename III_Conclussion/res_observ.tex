...
%! >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Response 3 - Point 5
\added[id=Responce 3]{One of the biggest challenges in bringing these results to a conclusion was coming up with a consistent methodology, which was appropriately reflected in both the accuracy and repeatability of each method.
