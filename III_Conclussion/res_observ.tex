...
Similar to Model \#1, Mamo and Wang~\cite{mamo_long_2020} utilised a single temperature range but with single or two profiles of DST, US06, or FUDS.
...
However, additional complexity to other processing introduced better overall accuracy, as per \mbox{Table~\ref{tab:acc-results1}}, which is similar to what was reported by Javid~\textit{et al.}~\cite{javid_adaptive_2020}.
...
Similar areas could have been observed on previously mentioned models with a lesser degree of inaccuracy.
