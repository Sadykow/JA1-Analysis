...
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/M2-history-DST-mae1.svg}
%         \caption{Average training and testing MAE history of multiple attempts}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/DST-2-train1.svg}
%         \caption{Validation on a single cycle of SoC estimation of multiple attempts at 25\textdegree{}C}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/DST-2-test1.svg}
%         \caption{Testing on two cycles of US06 and FUDS profiles of multiple attempts}
...
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/M2-history-US06-mae1.svg}
%         \caption{Average training and testing MAE history of multiple attempts}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/US06-2-train1.svg}
%         \caption{Validation on a single cycle of SoC estimation of multiple attempts at 25\textdegree{}C}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/US06-2-test1.svg}
%         \caption{Testing on two cycles of US06 and FUDS profiles of multiple attempts}
%     \end{subfigure}
%     % % %%%%%%%%%%%%%%%%% FUDS based tests %%%%%%%%%%%%%%%%%
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/M2-history-FUDS-mae1.svg}
%         \caption{Average training and testing MAE history of multiple attempts}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/FUDS-2-train1.svg}
%         \caption{Validation on a single cycle of SoC estimation of multiple attempts at 25\textdegree{}C}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.325\textwidth}
%         \centering
%         \includesvg[width=\linewidth]{III_Conclussion/Results_new/FUDS-2-test1.svg}
%         \caption{Testing on two cycles of DST and US06 profiles of multiple attempts}
%     \end{subfigure}
