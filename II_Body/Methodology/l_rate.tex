...
\begin{figure}[ht]
    ...
    \caption{Learning rate degradation. \textcolor{red}{ADD ANNOTATION}}
...
\textcolor{red}{It is shown in Figure~\ref{fig:l_rate_progress}, where two adaptive schemes are applied and reconverged from, and a final *** adaptive decay ends the training. Asymptote?}
%
