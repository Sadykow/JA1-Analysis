...
\begin{table*}[h]
    ...
    \begin{tabular}{l|l|l|c|c|c|c|l}
        ...
        \hline
        1 & 1 $\times$ LSTM (500)~\cite{Chemali2017} & $-$less & 0.001 &       &        &        &  \\
        2 & 1 $\times$ GRU (560)  & $-$less &       & 0.001 &        & 0.0005 & Ensemble~\cite{xiao_accurate_2019} \\
        3 & 1 $\times$ LSTM (520) & $-$less & 0.001 &       &        &        & Attention~\cite{mamo_long_2020} \\
        %4 & 2 $\times$ GRU (60)   & $-$ful  &       &       & 0.001  &        &  \\
        4 & 1 $\times$ GRU (500)  & $-$less & 0.001 &       &        &        & RoAdam~\cite{javid_adaptive_2020} \\
        5 & 2 $\times$ LSTM (250)~\cite{zhang_deep_2020} & $-$less & & 0.0001 &        &        &  \\
        \hline\hline
    \end{tabular}
    }
\end{table*}
