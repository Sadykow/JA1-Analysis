...
Each training stage has been written from the first principle using the CUDA-supported TensorFlow 2.3.1 framework's official documentation, with additional implementation to accommodate method modifications\cite{chollet_writing_2020}.
