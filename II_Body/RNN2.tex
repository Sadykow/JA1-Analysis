...
%
Two commonly used Recurrent Neural Network utilises memory cells: Gated Recurrent Unit (GRU) and Long Short-Term Memory (LSTM), with possible extensions implemented by the referenced articles' authors.
