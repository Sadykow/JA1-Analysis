...
The validation set is created from unseen data of another to report the accuracy of the training process only.
The training itself will be performed until the predefined loss function gets the error bellow 2,4\% or achieve maximum possible accuracy without overfitting.
The learning steps will not be affected by the overfitting process, and each failure will be preloaded with previous successfully trained model and repeated training several times.
%
