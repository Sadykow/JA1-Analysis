...
% \end{itemize}
% This section will define each step for future reference, which each model will go through.
...
\begin{table*}[h]
    ...
    \caption{
        ...
        Extensions define the model's specific detail, which distinguishes it against the others.
    }
    \centering
