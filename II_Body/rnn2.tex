...
\begin{tabular}{p{0.4cm}|p{3.4cm}|p{1.3cm}|p{1.0cm}|p{1.2cm}|p{1.5cm}|p{1.5cm}|p{3.0cm}}
    ...
    5 & 1 $\times$ GRU (500)  & $-$less & 0.001 &       &        &        & RoAdam\\
...
The problem is referred to as vanishing gradient when the value to update network weights shrinks as it propagates through time~\cite{rasifaghihi_predictive_2020}.
