...
One of the methods proposed by Cho \textit{et al.}~\cite{GRU_cho_properties_2014}, which improves the behaviour of the Neural network, is the Gated Recurrent Unit.
