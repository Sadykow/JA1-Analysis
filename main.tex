...
\input{./II_Body/Methodology}
    \input{./II_Body/b_data}
    \input{./II_Body/d_gen}
    \input{./II_Body/t_model}
    ...
    \end{landscape}
%%% Implementation
\section{Machine Learning approach evaluated} \label{sec:Body}
\input{./II_Body/rnn2}
...
\input{./III_Conclussion/figures} %! Separate figures and comment all by 1 for writing help.
