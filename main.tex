...
\newcommand{\orcidauthorA}{0000-0002-6436-7069} % Add \orcidA{} behind the author's name
\newcommand{\orcidauthorB}{0000-0002-2970-9158} % Add \orcidB{} behind the author's name
\newcommand{\orcidauthorC}{0000-0001-8137-9507} % Add \orcidB{} behind the author's name
\newcommand{\orcidauthorD}{0000-0001-7041-5904} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Marat Sadykov $^{1,\dagger,\ddagger}$\orcidA{}, Sam Haines$^{1,\dagger}$, Dr Mark Broadmeadow $^{2,\dagger}$, A/Prof Geoff Walker $^{2,\dagger}$\orcidC{} and A/Prof David Holmes $^{1,\dagger,\ddagger}$*\orcidB{}}
...
\address{%
$^{1}$ \quad School of Mechanical, Medical and Process Engineering\\
$^{2}$ \quad School of Electrical Engineering \& Robotics
}

% Contact information of the corresponding author
\corres{Correspondence: \href{mailto:d.holmes@qut.edu.au}{d.holmes@qut.edu.au} (D.W. Holmes)}

% Current address and/or shared authorship
\firstnote{Queensland University of Technology (QUT), Brisbane, QLD 4000, Australia}
...
\abstract{
	...
	This paper presents a practical usability investigation on Recurrent Neural Networks (RNN) to determine the best-suited machine learning method for Electric vehicles (EV) battery state of charge estimation.
    ...
    % against simulations of different driving conditions.
	% \begin{itemize}
	...
	Each method was examined by applying training techniques like a learning rate scheduler or rollback recovery to speed up fitting, highlighting implementation specifics, and all of that using the TensorFlow framework as close as possible to the published sources on openly available battery data.
	The results highlight the average percentage accuracy of 96.56\% of correct SoC estimation, several drawbacks of the overall implementation, and propose potential solutions for further improvement.
	Every implemented model had a similar drawback of poor capture of the middle area of charge, applying higher weight on voltage rather than current.
...
\authorcontributions{
    ...
    % Walker Geoff: ... . G.W
    Conceptualization, M.S., S.H., M.B and D.H.;
    methodology, M.S., D.H.;
    software, M.S.;
    validation, M.S., D.H. and G.W.;
    formal analysis, M.S., D.H.;
    investigation, M.S., M.B;
    resources, M.S., S.H.;
    data curation, M.S.;
    writing---original draft preparation, M.S.;
    writing---review and editing, M.S., D.H., G.W.;
    visualization, M.S.;
    supervision, D.H., G.W.;
    project administration, D.H.;
...
\dataavailability{
    The Lithium-Ion battery cycling data presented in this study are openly available in the Battery Research Group of the Center for Advanced Life Cycle Engineering (CALCE) Group official repository website, which can be accessed with the following \href{https://web.calce.umd.edu/batteries/data.htm}{link}, in the section of A123 batteries~\cite{noauthor_calce_2017}.
}
