...
\title{Critical analysis of Lithium-Ion battery State of Charge estimation methods using Time-Series Machine Learning prediction over supported chip-on-board devices for Electric Vehicles.}
