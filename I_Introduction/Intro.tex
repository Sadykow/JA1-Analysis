...
%
%
While some model-based methods, such as the equivalent circuit model, are simple to implement within a BMS, many cannot correctly capture a batteries' complex multi-dependant behaviour~\cite{6953745}.
...
% non-connected predictions, allowing to be used any time, independemtly from previos results or inputs.
...
%! [SUbsets of ML for SoC, addining references.]
%! WHich is best and why testing... Talk about ML and just refer to authors just as process.
%! Intro WHre are specifics. Hyper-para. THere is w\a hole range, Table summarises many.
%! Stateful is this and [] implemented GRU and this hthis. Results tateless was better.
%! No clear winner on optimisers. Fitting process..
...
%!Follow the table. Focus on not what they did, buut what I will do and refer to 
%!whoever did similar.
...
\textcolor{yellow}{TODO: Distribute references by whoever uses them.}
...
\begin{enumerate}
    \item only discharge [ref, ref, ref]
    \item charge-discharge
    \item multiple of cycles
    \item Limits of one cycle, benefits of multiple, examples to compare to
\end{enumerate}
